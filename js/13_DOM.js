...
document.getElementById("btn1").addEventListener("click", function() {
    ...
    // #test의 첫번째 자식노드 찾기
    console.log(li1.firstChild);
    // #test의 마지막 자식노드 찾기
    console.log(li1.lastChild);
    // #test의 자식노드 중 5번째 인덱스 노드 찾기
    console.log(li1.childNodes[5]);
    // #test의 자식 노드 중 5번째 인덱스 노드의 마지막 자식으로 "ZZZ" 추가하기
    testNodeList.childNodes[5].append("ZZZ");
    // #test의 자식 노드 중 5번째 인덱스의 이전 형제 노드
    console.log(li1.childNodes[5].previousSibling); // 4번

    // #test의 자식 노드 중 5번째 인덱스의 다음 형제 노드
    console.log(li1.childNodes[5].nextSibling); // 6번

    // #test의 자식 노드 중 5번째 인덱스의 이전 형제 노드의 이전 형제 노드
    console.log(li1.childNodes[5].previousSibling.previousSibling);
...
document.getElementById("btn2").addEventListener("click", function() {
  ...
  // #test의 모든 자식 요소 탐색
    const list = test.children; // HTMLCollection형태로 반환
    console.log(list);

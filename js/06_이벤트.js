...
document.getElementById("btn1").onclick = function(){
    ...
    // 요소의 속성 중 on이벤트명 속성에 함수대신 null을대입하여
    // 이벤트 삭제 (변수에 값을 새로 대입하여 덮어쓰기하는 원리ㅣ)
...
// 고전 이벤트 모델 단점
// -> 한 요소에 동일한 이벤트 리스너에 
// 다수의 이벤트로 팬들러를 작성할 숭 있다
//  (마지막으로 대입되는 이벤트 젠틀러만 사용)

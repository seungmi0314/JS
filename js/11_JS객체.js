...
document.getElementById("btn1").addEventListener("click", function(){
    ...
    div1.innerHTML += "product.brand : " + product.pName + "<br>";
    div1.innerHTML += "product.color : " + product.pName + "<br>";
    div1.innerHTML += "product.color : " + product.pName + "<br>";
    div1.innerHTML += "<hr>";
...
function Student(grade, ban, name) { 
    ...
    this.grade = grade;
    // 매개변수 grade값을 생성되는 객체의 grade 에 대입
    this.ban = ban;
    this.name = name;

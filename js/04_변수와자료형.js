...
// console.log("함수 외부 num3 : " + num3); // num3 is not defined // 지역변수라서 그럼
// 함수 종료 후에는 사용 불가

// *** script 언어는 중간에 에러가 발생하면 해석을 멈춘다 ***
console.log("함수 외부 num4 : " + num4);
// 전역변수라서 함수 종료 후에도 사용 가능

// console.log("함수 외부 num5 : " + num5); -> 지역변수

// console.log("함수 외부 num6 : " + num6); // -> 전역변수
...
function typeTest() {
    ...
    // console.log(temp3); // error (블럭범위 벗어나서)
    ...
    // 함수명(매개변수) == 함수호출 (함수 코드가 수행 됨)
    typeBox.innerHTML += "<br><br>fnSum : " + fnSum(1,2);
